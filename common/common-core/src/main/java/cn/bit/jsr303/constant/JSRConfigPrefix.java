package cn.bit.jsr303.constant;

public class JSRConfigPrefix {
    // String Enum
    public static final String ANY_STRING_PREFIX = "any-string";
    public static final String USERNAME_STRING_PREFIX = "username-string";
    public static final String PASSWORD_STRING_PREFIX = "password-string";
    public static final String PHONE_STRING_PREFIX = "phone-string";
    public static final String EMAIL_STRING_PREFIX = "email-string";
    public static final String URL_STRING_PREFIX = "url-string";
    public static final String GENDER_STRING_PREFIX = "gender-string";
    public static final String QQ_STRING_PREFIX = "qq-string";
    public static final String WECHAT_STRING_PREFIX = "wechat-string";
    public static final String ID_CARD_STRING_PREFIX = "id-card-string";
